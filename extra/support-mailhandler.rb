...
#   -p, --project                  identifier of the target project
#   
# General options:
...
class RedmineMailHandler
  ...
  attr_accessor :verbose, :issue_attributes, :allow_override, :unknown_user, :no_permission_check, :url, :key, :project
  ...
  def initialize
    ...
    RDoc.usage if issue_attributes['project'].nil?
  end
  
  def submit(email)
    uri = url.gsub(%r{/*$}, '') + "/support/#{issue_attributes['project']}"
